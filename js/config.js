...
if(GameID == 19) {
	...
	tempLocationImages = ["Abyssal Ruins_1F","Abyssal Ruins_2F","Abyssal Ruins_3F","Abyssal Ruins_4F","Accumula Town_Autumn","Accumula Town_Spring","Accumula Town_Summer","Accumula Town_Winter","Anville Town_Spring","Big Stadium Small Court_Exterior","Castelia City_Castelia Gym Exterior","Castelia City_Castelia Gym Guide","Castelia City_Castelia Gym","Celestial Tower_1F","Celestial Tower_2F","Celestial Tower_3F","Celestial Tower_4F","Celestial Tower_Autumn","Celestial Tower_Rooftop","Celestial Tower_Spring","Celestial Tower_Summer","Celestial Tower_Winter","Challengers Cave_1F","Challengers Cave_B1F","Challengers Cave_B2F","Cold Storage","Cold Storage_Back Room","Cold Storage_Exterior Autumn","Cold Storage_Exterior Spring","Cold Storage_Exterior Summer","Cold Storage_Exterior Winter","Desert Resort_Entrance","Driftveil City_Driftveil Gym Bottom","Driftveil City_Driftveil Gym Entrance","Driftveil City_Driftveil Gym Exterior","Driftveil City_Driftveil Gym","Driftveil City_Spring","Driftveil Drawbridge","Gate_Inside","Gear Station","Giant Chasm_Cave","Giant Chasm_Caves Deepest Part","Giant Chasm_Crater Forest Summer","Giant Chasm_Entrance Summer","GTS Trade Room","Icirrus City_Icirrus Gym Exterior","Icirrus City_Icirrus Gym","Icirrus City_Pokémon Fan Club","Icirrus City_Spring","Icirrus City_Winter","Lacunosa Town_Spring","Liberty Garden_Lighthouse Basement","Liberty Garden_Lighthouse","Liberty Garden_Summer","Mistralton Cave_1F","Mistralton Cave_2F","Mistralton Cave_3F","Mistralton City_Mistralton Gym Exterior","Mistralton City_Mistralton Gym","Mistralton City_Spring","Nacrene City_Nacrene Gym Basement","Nacrene City_Nacrene Gym Exterior","Nacrene City_Nacrene Gym Library","Nacrene City_Spring","names.bat","names.txt","Nimbasa City_Nimbasa Gym Exterior","Nimbasa City_Nimbasa Gym","Nimbasa City_Spring","Nuvema Town_Autumn","Nuvema Town_Spring","Nuvema Town_Summer","Nuvema Town_Winter","Opelucid City","Opelucid City_Opelucid Gym Exterior","P2 Laboratory_Autumn","P2 Laboratory_Interior","P2 Laboratory_Spring","P2 Laboratory_Summer","P2 Laboratory_Winter","Passerby Analytics HQ","Relic Castle_1F L","Relic Castle_1F R","Relic Castle_B1F B2F B3F L","Relic Castle_B1F R","Relic Castle_B2F R","Relic Castle_B3F R","Relic Castle_B4F B5F L","Relic Castle_B4F R","Relic Castle_B5F B6F R","Relic Castle_B6F L","Relic Castle_B7F L","Relic Castle_B7F Maze","Relic Castle_B7F R","Relic Castle_B7F Volcarona Room","Route 10_Basic Badge Gate","Route 10_Bolt Badge Gate","Route 10_Desolate Gate","Route 10_Freeze Badge Gate","Route 10_Insect Badge Gate","Route 10_Jet Badge Gate","Route 10_Legend Badge Gate","Route 10_Quake Badge Gate","Route 10_Summer","Route 10_Trio Badge Gate","Route 17_Autumn","Route 17_Spring","Route 17_Summer","Route 17_Winter","Route 18_Summer","Route 1_Autumn","Route 1_Spring","Route 1_Summer","Route 1_Winter","Route 2_Autumn","Route 2_Spring","Route 2_Summer","Route 2_Winter","Royal Unova_Interior","Shopping Mall Nine","Striaton City_Spring","Striaton City_Striaton Gym Exterior","Striaton City_Striaton Gym","Striaton City_Striaton Trainers School Exterior","Striaton City_Striaton Trainers School Interior","Twist Mountain_1F","Twist Mountain_2F","Twist Mountain_3F","Twist Mountain_B1F","Twist Mountain_Exterior","Twist Mountain_Route 7 Autumn","Undella Town_Spring","Victory Road","Victory Road_1F L","Victory Road_1F M","Victory Road_1F R","Victory Road_2F L","Victory Road_2F R","Victory Road_3F L","Victory Road_3F M","Victory Road_3F R","Victory Road_4F L","Victory Road_4F M","Victory Road_4F R","Victory Road_5F","Victory Road_6F Trial Chamber","Victory Road_6F","Victory Road_7F","Village Bridge_Spring"];
}
if(GameID == 20) {
...
if(GameID >= 17 && GameID <= 18) {
	...
	tempLocationImages = ["Azalea Gym","Azalea Town","Battle Tower","Bell Tower","Bell Tower_10F","Bell Tower_1F","Bell Tower_2F","Bell Tower_3F","Bell Tower_4F","Bell Tower_5F","Bell Tower_6F","Bell Tower_7F","Bell Tower_8F","Bell Tower_9F","Bell Tower_Summit","Bellchime Trail","Blackthorn City","Blackthorn Gym","Brass Tower","Bruno Room","Burned Tower_1F","Burned Tower_B1F","Celadon City","Celadon City_Celadon Gym","Celadon Condominiums","Celadon Condominiums_1F","Celadon Condominiums_2F","Celadon Condominiums_3F","Celadon Condominiums_Know It All Room","Celadon Condominiums_Rooftop","Celadon Department Store","Celadon Department Store_1F","Celadon Department Store_2F","Celadon Department Store_3F","Celadon Department Store_4F","Celadon Department Store_5F","Celadon Department Store_Rooftop","Celadon Game Corner","Celadon Game Corner_Inside J","Celadon Game Corner_Inside","Celadon Game Prize Corner","Cerulean Cape","Cerulean Cave_1F","Cerulean Cave_2F","Cerulean Cave_B1F","Cerulean City","Cerulean Gym","Champion Room","Cherrygrove City","Cianwood City","Cianwood Gym","Cinnabar Gym","Cinnabar Island","Cliff Cave_1F","Cliff Cave_2F","Cliff Cave_B1F","Cliff Edge Gate","Copycat House 1F","Copycat House 2F","Dark Cave_1","Dark Cave_2","Day Care","Diglett Cave","Dragons Den Dragon Shrine","Dragons Den Entrance","Dragons Den","Ecruteak City","Ecruteak Gym","Embedded Tower_Groudon","Embedded Tower_Kyogre","Embedded Tower_Rayquaza","Frontier Access","Fuchsia City","Fuchsia Gym","Gate Inside","Glitter Lighthouse","Glitter Lighthouse_1F","Glitter Lighthouse_2F","Glitter Lighthouse_3F Balcony","Glitter Lighthouse_3F","Glitter Lighthouse_4F","Glitter Lighthouse_5F","Glitter Lighthouse_6F","Global Terminal 1F","Global Terminal 2F","Global Terminal 3F","Global Terminal Exterior","Goldenrod City","Goldenrod Department Store","Goldenrod Department Store_1F","Goldenrod Department Store_2F","Goldenrod Department Store_3F","Goldenrod Department Store_4F","Goldenrod Department Store_5F","Goldenrod Department Store_6F","Goldenrod Department Store_Basement","Goldenrod Game Corner_Exterior","Goldenrod Game Corner_Interior JP","Goldenrod Gym","Goldenrod Radio Tower","Goldenrod Radio Tower_1F","Goldenrod Radio Tower_2F","Goldenrod Radio Tower_3F","Goldenrod Radio Tower_4F","Goldenrod Radio Tower_5F","Goldenrod Radio Tower_Observation Deck","Goldenrod Tunnel","Goldenrod Tunnel_Basement","GTS Trade Room","Hall of Fame","House of Memories","House of Memories_Interior","Ice Path_1F","Ice Path_B1F","Ice Path_B2F","Ice Path_B3F","Ilex Forest","Indigo Plateau","Indigo Plateau_Center","Johto Route 29","Johto Route 30","Johto Route 31","Johto Route 32","Johto Route 33","Johto Route 34","Johto Route 35","Johto Route 36","Johto Route 37","Johto Route 38","Johto Route 39","Johto Route 40","Johto Route 41","Johto Route 42","Johto Route 43","Johto Route 44","Johto Route 45","Johto Route 46","Johto Route 47","Johto Route 48","Johto Safari Zone","Johto Safari Zone_Desert","Johto Safari Zone_Forest","Johto Safari Zone_Marshland","Johto Safari Zone_Meadow","Johto Safari Zone_Mountain","Johto Safari Zone_Peak","Johto Safari Zone_Plains","Johto Safari Zone_Rocky Beach","Johto Safari Zone_Savannah","Johto Safari Zone_Swamp","Johto Safari Zone_Wasteland","Johto Safari Zone_Wetland","Kanto Route 1","Kanto Route 10","Kanto Route 11","Kanto Route 12","Kanto Route 13","Kanto Route 14","Kanto Route 15","Kanto Route 16","Kanto Route 17","Kanto Route 18","Kanto Route 19","Kanto Route 2","Kanto Route 20","Kanto Route 21","Kanto Route 22","Kanto Route 24","Kanto Route 25","Kanto Route 26","Kanto Route 27","Kanto Route 28","Kanto Route 3","Kanto Route 4","Kanto Route 5","Kanto Route 6","Kanto Route 7","Kanto Route 8","Kanto Route 9","Karen Room","Koga Room","Lake of Rage dry","Lake of Rage wet","Lavender Radio Tower 1F","Lavender Radio Tower","Lavender Town","Mahogany Gym","Mahogany Town","Mahogany Town_Shop","Miracle Cycle Cerulean Interior","Miracle Cycle Goldenrod Interior","MooMoo Farm Barn","MooMoo Farm House","MooMoo Farm","Mt Moon 1F","Mt Moon Square","Mt Mortar Basement","Mt Mortar Entrance","Mt Mortar Lower Cave","Mt Mortar Upper Cave","Mt. Silver_1F","Mt. Silver_2F","Mt. Silver_3F","Mt. Silver_Expert Belt","Mt. Silver_Exterior","Mt. Silver_Lower Mountainside","Mt. Silver_Moltres","Mt. Silver_Summit","Mt. Silver_Upper Mountainside","names.bat","names.txt","National Park","New Bark Town","Olivine City","Olivine Gym","Pal Park","Pallet Town","Pewter City","Pewter Gym","Pewter Museum of Science","Pewter Museum of Science_Interior","Player House Exterior","Pokéathlon Dome","Pokéathlon Dome_1F","Pokéathlon Dome_2F Entrance","Pokéathlon Dome_2F","Pokéathlon Dome_B1F Friendship","Pokéathlon Dome_B1F Potential","Pokéathlon Dome_B1F Solidarity","Pokéathlon Dome_B1F Trust","Pokémon Fan Club Interior","Pokémon League_Reception Gate","Pokémon School Interior","Pokémon School","Power Plant_Exterior","Power Plant_Interior","Professor Oak Lab Inside","Professor Oak Lab","Red House Exterior","Rock Tunnel_1","Rock Tunnel_2","Rocket Hideout B1F","Rocket Hideout B2F","Rocket Hideout B3F","Rotoms Room","Ruins of Alph_Entrance","Ruins of Alph_first chamber","Ruins of Alph_fourth chamber","Ruins of Alph_Interior","Ruins of Alph_Item","Ruins of Alph_Outside","Ruins of Alph_Puzzle","Ruins of Alph_second chamber","Ruins of Alph_third chamber","Safari Zone_Gate","Saffron City","Saffron Gym","Seafoam Islands_1F","Seafoam Islands_B1F","Seafoam Islands_B2F","Seafoam Islands_B3F","Seafoam Islands_B4F","Silph Co 1F","Silph Co","Silver Cave Entrance","Sinjoh Ruins","Sinjoh Ruins_Cabin","Sinjoh Ruins_Mystri Stage Active","Sinjoh Ruins_Mystri Stage","Slowpoke Well_B1F","Slowpoke Well_B2F","Slowpoke Well_Entrance","Sprout Tower","Sprout Tower_1F","Sprout Tower_2F","Sprout Tower_3F","SS Aqua 1F Rooms","SS Aqua 1F","SS Aqua B1F","SS Aqua Captain Cabin","Tohjo Falls","Tohjo Falls_Hidden Room","Trainer House_1F","Trainer House_B1F","Trainer House_Outside","Underground Path 5-6","Underground Warehouse","Union Cave_1F","Union Cave_B1F","Union Cave_B2F","Vermilion City","Vermilion Gym","Victory Road_1F","Victory Road_2F","Victory Road_3F","Violet City","Violet Gym","Viridian City","Viridian Forest","Viridian Gym","Whirl Islands_1F NE","Whirl Islands_1F NW","Whirl Islands_1F SE","Whirl Islands_1F SW","Whirl Islands_B1F","Whirl Islands_B2F","Whirl Islands_B3F Lugia","Whirl Islands_B3F","Will Room"];
}
